...
example `<your_GitHub_username>-2019HW1` for Homework 1. 
...
> `$ git clone https://github.com/datasciencelabs-students/<your_GitHub_username>-2019HW1.git`

<center><img src="./images/mkdir-clone.png" alt="gitclean" style="width: 600px;"/></center>

6. You should now see a new directory called `<your_GitHub_username>-2019HW1`. 
