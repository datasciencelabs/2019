...
We will first practice how to pull, work on and submit your homework on github. We have set up a  homework #1 repo for you. Go to the [datasciencelabs-student github page](https://github.com/datasciencelabs-students) and look for a repository named `<your GitHub username>-2019HW1`. Click on the repository and follow the next steps below.
