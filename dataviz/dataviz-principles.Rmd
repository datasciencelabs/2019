...
To illustrate how some of these strategies compare let's suppose we want to report the results from two hypothetical polls regarding browser preference taken in 2000 and then 2015. Here, for each year, we are simply comparing four quantities, four percentages.
...
The average of each group is represented by the top of each bar and the antennae expand to the average plus two standard errors. If all E.T. receives is this plot he will have little information on what to expect if he meets a group of human males and females. The bars go to 0, does this mean there are tiny humans measuring less than one foot? Are all males taller than the tallest females? Is there a range of heights? E.T. can't answer these questions since we have provided almost no information on the height distribution.
